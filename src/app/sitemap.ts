...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    // Lösungen
    { path: '/loesungen/freelancer', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/loesungen/kleinunternehmer', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/loesungen/startups', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/loesungen/ecommerce', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/loesungen/agenturen', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/loesungen/handwerk', priority: 0.7, changeFrequency: 'monthly' as const },
    // Erkunden
